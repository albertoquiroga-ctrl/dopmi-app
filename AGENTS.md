...
- Current delivery: milestone 2 (adoption publications, moderation, catalog, favorites, public profiles, private messaging and in-app notifications). Milestone 1 is complete and must keep working.
