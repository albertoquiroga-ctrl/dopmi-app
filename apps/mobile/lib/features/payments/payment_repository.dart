...
String paymentError(Object cause) {
  ...
  if (cause is FunctionException) {
    ...
    return switch (code) {
      ...
      'stripe_permission_denied' || 'stripe_authentication_failed' =>
        'La conexión de Dopmi con Stripe necesita revisión del equipo. No vuelvas a pagar.',
      'processor_busy' =>
        'La aportación sigue en proceso. Actualiza el historial en un momento; no vuelvas a pagar.',
