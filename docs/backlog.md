...
- [ ] H5.E Android 2.3.3 (247), SHA `3fe7a1d`, publicado por Codemagic e instalado desde Google Play interno; recorridos acreditados con capturas del titular. Modelo confirmado: Samsung Galaxy S25 Ultra (SM-S938B). Falta registrar versión de Android y publicar/verificar el arreglo visual `37895d2` en un nuevo build. TestFlight queda como alternativa.
