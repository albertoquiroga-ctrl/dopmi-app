...
- [ ] H5.3 Reservar con transacción y bloqueo los saldos elegibles en servidor; estimar comisiones antes del cobro, revalidar el neto real al confirmar y reembolsar excedentes de manera auditable.
