...
- **Pendiente:** comprobar el pago real de una factura individual con un medio de pago exclusivamente de prueba y confirmar que una renovación posterior queda en borrador; probar igualmente falla/reintento del servidor. La integración no puede habilitar cobros hasta completar esas pruebas y los controles de asignación y conciliación.
