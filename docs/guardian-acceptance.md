...
Pendientes de aceptación integrada: calendario de fin de mes y escritura incierta al cruzar aniversario; captura de la recuperación financiera ya verificada en servidor; disputa posterior a transferencia y recuperación de reversión con resultado incierto; comprobación visual específica del aviso tras retirar monto. Devolución completa a dos destinos y pantalla de revisión de disputa inicial ya aceptadas. La captura de paginación no identifica build ni acredita esa corrección. Los tests locales de otros casos no sustituyen evidencia integrada. Conservar H5.3–H5.5 y H5.G–H5.H abiertos hasta satisfacer la matriz completa.
